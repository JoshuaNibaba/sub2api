export default {
  ...
  enterprise: {
    title: '大客户中心',
    description: '查看脱敏号池状态、个人用量和有限的错误日志。',
    accountPool: '号池状态',
    accountPoolHint: '仅显示运行状态和容量信息，不会返回任何凭据、代理认证或上游地址。',
    usageLogs: '用量记录',
    usageLogsHint: '仅限当前账号的用量记录。',
    errorLogs: '错误日志',
    errorLogsHint: '仅限当前账号的脱敏错误信息。',
    requestRouting: '请求命中账号',
    requestRoutingHint: '仅显示当前账号发起的请求及其命中的账号；非本人账号会使用 **** 脱敏。',
    requestTime: '时间',
    model: '模型',
    hitAccount: '命中账号',
    cost: '费用',
    recentRecords: '共 {count} 条记录',
    total: '共 {count} 个账号',
    name: '名称',
    platform: '平台',
    type: '类型',
    ...
    capacity: '并发容量',
    lastUsed: '最近使用',
    healthValues: { healthy: '健康', degraded: '降级', unavailable: '不可用' },
  },
