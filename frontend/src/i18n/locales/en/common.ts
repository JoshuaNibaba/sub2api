export default {
  ...
  enterprise: {
    ...
    requestRoutingHint: 'Shows requests from the current account and the selected upstream account; other account names are masked with ****.',
    requestTime: 'Time',
    model: 'Model',
    hitAccount: 'Selected account',
    cost: 'Cost',
