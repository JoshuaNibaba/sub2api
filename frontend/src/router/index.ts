...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      requiredPermission: Permission.AdminDashboardRead,
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      requiredPermission: Permission.AdminOpsRead,
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      requiredPermission: Permission.AdminAuditRead,
      title: 'Audit Logs',
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      requiredPermission: Permission.AdminUsersRead,
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      requiredPermission: Permission.AdminGroupsRead,
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      requiredPermission: Permission.AdminPluginsWrite,
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      requiredPermission: Permission.AdminSettingsRead,
      title: 'Announcements',
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      requiredPermission: Permission.AdminProxiesRead,
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      requiredPermission: Permission.AdminPaymentRead,
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      requiredPermission: Permission.AdminSecurityRead,
      title: 'Risk Control',
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      requiredPermission: Permission.AdminUsageRead,
      title: 'Usage Records',
